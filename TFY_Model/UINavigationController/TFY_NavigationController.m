...
- (void)setupNavigationBarTheme
{
    ...
    [navBar setBackgroundImage:[self tfy_createImage:[UIColor blackColor]] forBarMetrics:UIBarMetricsDefault];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    if (self.viewControllers.count > 0) {
        // 返回按钮目前仅支持图片
        UIImage *backImage = self.backIconImage ?: [[self navigationBarBackIconImage] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];;
